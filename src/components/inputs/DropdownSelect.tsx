...
export const DropdownSelect = forwardRef<HTMLSelectElement, DropdownSelectProps>(({
  ...
  const colorClasses = (() => {
    ...
    return 'border-_components-text-primary text-[var(--components-text-primary)] placeholder-[var(--components-text-secondary)] hover:bg-_components-background-contrast-sm';
  })();
