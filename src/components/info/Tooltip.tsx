  ...
  return (
    <div className="relative inline-flex group">
      ...
      <div
        id={id}
        role="tooltip"
        className={`pointer-events-none absolute z-10 whitespace-nowrap rounded-md bg-_components-tooltip-fill px-3 py-1 text-body-xs text-_components-text-light opacity-0 transition-opacity duration-200 group-hover:opacity-100 group-focus-within:opacity-100 ${bubblePosition[direction]} ${className}`}
      >
        {content}
        {/* Arrow */}
