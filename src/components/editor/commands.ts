 ...
 */
export function createHeadingCommand(level: 1 | 2 | 3 | 4 | 5 | 6): FormatCommand {
  return {
    id: `heading-${level}`,
    name: `Heading ${level}`,
 ...
 * Paragraph command
 */
export const paragraphCommand: FormatCommand = {
  id: 'paragraph',
  name: 'Paragraph',
 ...
 * Remove link command
 */
export const removeLinkCommand: FormatCommand = {
  id: 'removeLink',
  name: 'Remove Link',
 ...
 */
export const addTableRowCommand: FormatCommand = {
  id: 'addTableRow',
  name: 'Add Row',
 ...
 */
export const addTableColumnCommand: FormatCommand = {
  id: 'addTableColumn',
  name: 'Add Column',
 ...
 */
export const increaseIndentCommand: FormatCommand = {
  id: 'increaseIndent',
 ...
 */
export const decreaseIndentCommand: FormatCommand = {
  id: 'decreaseIndent',
 ...
 */
export function createTextAlignCommand(align: 'left' | 'center' | 'right' | 'justify'): FormatCommand {
  return {
    id: `textAlign-${align}`,
 ...
 */
export const clearFormattingCommand: FormatCommand = {
  id: 'clearFormatting',
 ...
 * Select all command
 */
export const selectAllCommand: FormatCommand = {
  id: 'selectAll',
  name: 'Select All',
 ...
 * Undo command
 */
export const undoCommand: FormatCommand = {
  id: 'undo',
  name: 'Undo',
 ...
 * Redo command
 */
export const redoCommand: FormatCommand = {
  id: 'redo',
  name: 'Redo',
